...
exprToString VarX                 = "x"
exprToString VarY                 = "y"
exprToString (Sine e)             = "sin(pi*" ++ exprToString e ++")"   -- ++ jkdgfsdkja e ++ ---How you plug e into char[]--or string 
...
---eval x y e = error "TBD:eval" eval x y e using e as expr
eval x y VarX = x
eval x y VarY = y
...
--"(e1<e2?e3:e4)" if e1 < e2, then e3, else e4
